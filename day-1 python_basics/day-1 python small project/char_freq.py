...
"""
text1  =input("Enter your text here: ")
space  =input("Count spaces? (yes/no):").lower()
case   =input("Case sensetive? (yes/no):").lower()
storage = {}

if space == 'yes' and  case == 'no':
    text = text1.lower()
    for char in text:
        if char in storage:
            storage[char] += 1
